...
export default function Landing() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Intelligent project scheduling with automated deadline tracking and milestone management.',
    },
    {
      icon: BarChart3,
      title: 'Advanced Analytics',
      description:
        'Get deep insights into project performance with comprehensive reporting and analytics.',
    },
    {
      icon: Zap,
      title: 'Lightning Fast',
      description:
        'Built for speed with modern technology stack ensuring smooth and responsive experience.',
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description:
        'Organize, prioritize, and track tasks with our intuitive task management system.',
    },
  ];
  ...
  const testimonials = [
    {
      ...
      company: 'TechCorp',
      content:
        'This platform has revolutionized how we manage projects. Our team productivity increased by 40%.',
      rating: 5,
    },
    {
      name: 'Michael Chen',
      ...
      company: 'StartupXYZ',
      content:
        'The intuitive interface and powerful features make project management a breeze. Highly recommended!',
      rating: 5,
    },
    {
      name: 'Emily Davis',
      ...
      company: 'GlobalCorp',
      content:
        'Finally, a project management tool that actually works as promised. Game-changer for our organization.',
      rating: 5,
    },
  ];
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-indigo-100 via-white to-purple-100 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            projects on time with our all-in-one platform.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/login">
              <Button
                size="lg"
                variant="outline"
                className="border-indigo-600 text-indigo-600 hover:bg-indigo-50 px-8 py-6"
              >
                LogIn
              </Button>
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Our toolset helps you manage projects effortlessly across teams
              and timelines.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-gray-50 hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                <CardHeader>
      ...
      <section className="py-20 bg-indigo-700 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of teams and simplify your project workflow today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/">
              <Button
                size="lg"
                className="bg-white text-indigo-700 hover:bg-gray-100 px-8 py-6"
              >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-indigo-700 px-8 py-6"
            >
              Contact Sales
            </Button>
          </div>
